 ...
 * @author trung
 */
public class JFrameDanhMucSP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Quản lý danh mục sản phẩm");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameDanhMucSP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadDataToTable() {
        ArrayList<DanhMuc> listDanhMuc = danhMucService.getAllDanhMuc();
        model.setRowCount(0);
        for (DanhMuc danhMuc : listDanhMuc) {
            model.addRow(new Object[]{
                danhMuc.getMaDM(),
                danhMuc.getTenDanhMuc(),
                danhMuc.isTrangThai() == true ? "Còn hàng":"Hết hàng"
            });
        }
    }
}
