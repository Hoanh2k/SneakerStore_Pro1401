 ...
 * @author trung
 */
public class JFrameMauSacSP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Quản lý màu sắc sản phẩm");
        ...
        jPanel4Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel1, jLabel3, jLabel4});
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        // TODO add your handling code here:
        MauSac mauSac = getMauSacFromInput();
        try {
            if (mauSacService.addMauSac(mauSac) != null) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameMauSacSP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadDataToTable() {
        ArrayList<MauSac> listMauSac = mauSacService.getAllMauSac();
        model.setRowCount(0);
