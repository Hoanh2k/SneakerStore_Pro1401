...
import service.impl.ChatLieuMGServiceImpl;

/**
 *
 * @author trung
 */
public class JFrameChatLieuSP extends javax.swing.JFrame {

    /**
     * Creates new form JFrameQuanLySanPham
     */
    private final ChatLieuMGService chatLieuMGService = new ChatLieuMGServiceImpl();
    DefaultTableModel model = new DefaultTableModel();
    int index;

    public JFrameChatLieuSP() {
        initComponents();
        setLocationRelativeTo(null);
        model = (DefaultTableModel) tblChatLieuMG.getModel();
        loadDataToTable();
    }
    ...
    private void initComponents() {
        ...
        tblChatLieuMG = new javax.swing.JTable();
        ...
        jLabel2.setText("Quản lý chất liệu sản phẩm");
        ...
        tblChatLieuMG.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblChatLieuMG);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameChatLieuSP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tblChatLieuMG;
    private javax.swing.JTextField txtMaMau;
    private javax.swing.JTextField txtTenMau;
    // End of variables declaration//GEN-END:variables

    private void loadDataToTable() {
        ArrayList<ChatLieu> listChatLieuMG = chatLieuMGService.getAllChatLieuMG();
        model.setRowCount(0);
        for (ChatLieu chatLieuMG : listChatLieuMG) {
            model.addRow(new Object[]{
                chatLieuMG.getMaCL(),
                chatLieuMG.getTenChatLieu(),
                chatLieuMG.isTrangThai() == true ? "Còn hàng" : "Hết hàng"
            });
        }
    }
}
