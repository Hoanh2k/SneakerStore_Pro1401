...
public class Voucher {
    ...
    public Voucher(String tenKhuyenMai, Date ngayBD, Date ngayKT, double mucGiam, String maGiam, boolean donVi,
            boolean trangThai) {
    ...
    public Voucher(int maKM, String tenKhuyenMai, Date ngayBD, Date ngayKT, double mucGiam, String maGiam,
